...
const ShelfContainer = ({ onProductClick, onProductHover, isOwner, selectedCategory, onEditClick, shopName: propShopName, products }) => {
    ...
    for (let i = 0; i < NUM_SHELVES; i++) {
        ...
        shelves.push(products.slice(startIndex, endIndex));
    }
